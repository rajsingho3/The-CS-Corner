  ...
  if (showOtpVerify) {
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden'>
      ...
      <div className='absolute top-0 left-0 w-full h-full'>
        ...
        <div className='absolute -bottom-8 left-40 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000'></div>
            ...
            <div className='hidden lg:block space-y-5 animate-fade-in-left'>
              <div className='text-center lg:text-left'>
                ...
                <p className='text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-5'>
                  Start your engineering journey with the best community
                </p>
              </div>
              
              <div className='space-y-4'>
                {[
                  { icon: '🚀', title: 'Join the Community', desc: 'Connect with thousands of engineers sharing knowledge worldwide' },
                  { icon: '📚', title: 'Premium Content', desc: 'Access exclusive study materials and engineering resources' },
                  { icon: '🎯', title: 'Personalized Learning', desc: 'Get AI-powered recommendations tailored to your goals' },
                  { icon: '🌟', title: 'Career Growth', desc: 'Build your professional network and advance your career' }
                ].map((item, index) => (
              ...
              <div className='bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/20 overflow-hidden hover:shadow-3xl transition-all duration-500'>
                ...
                <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-6 py-6 relative overflow-hidden'>
                  ...
                  <div className='relative z-10 text-center'>
                    ...
                    <h2 className='text-2xl font-bold text-white mb-1'>Join Us Today!</h2>
                    <p className='text-white/90 text-base'>Create your engineering account</p>
                  </div>
                </div>

                {/* Card body */}
                <div className='px-6 py-6'>                  <form className='space-y-3' onSubmit={handleSubmit}>
                    <div className='space-y-1'>
                      <Label value='Username' className='text-gray-700 dark:text-gray-300 font-semibold text-xs uppercase tracking-wider' />
                    ...
                    <div className='space-y-1'>
                      ...
                      <div className='flex items-center space-x-2 mt-1'>
                        <div className='flex-1 h-1 bg-gray-200 dark:bg-gray-700 rounded-full'>
                          <div className='h-1 bg-gradient-to-r from-red-500 via-yellow-500 to-green-500 rounded-full transition-all duration-300' style={{width: '33%'}}></div>
                        </div>
                        <span className='text-xs text-gray-500 dark:text-gray-400'>Strength</span>
                      </div>
                      <p className='text-xs text-gray-500 dark:text-gray-400 leading-relaxed'>
                        Must include 8+ characters with letters, numbers & symbols
                      </p>
                    </div>
                    ...
                    <div className='relative my-5'>
                      ...
                      <div className='relative flex justify-center text-xs'>
                        <span className='px-3 bg-white dark:bg-gray-800 text-gray-500 font-medium'>Or sign up with</span>
                      </div>
                    </div>
                  ...
                  <div className='mt-5 text-center p-3 bg-gray-50 dark:bg-gray-900/50 rounded-lg'>
                    ...
                    <Link to='/signin' className='text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-semibold transition-colors duration-300 hover:underline text-sm'>
                      Sign In Now
                    </Link>
                  </div>
                </div>
